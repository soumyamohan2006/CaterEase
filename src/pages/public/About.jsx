        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-500 mt-4 leading-relaxed">
              CaterEase was founded with a simple mission — to take the stress out of event planning. We connect you with the best vendors, provide powerful tools to manage every detail, and ensure your event is nothing short of extraordinary.
            </p>
            <p className="text-gray-500 mt-3 leading-relaxed">
              From intimate birthday dinners to grand weddings, we've helped thousands of customers create unforgettable memories across Kerala and beyond.
            </p>
          </div>
